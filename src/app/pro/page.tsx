...
export default function ProPage() {
  return (
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col justify-center px-5 py-16 sm:px-8">
      <p className="text-sm font-semibold uppercase tracking-[0.2em] text-cyan-300">Coming soon</p>
      <h1 className="mt-4 text-5xl font-bold tracking-tight text-white">Pro</h1>
